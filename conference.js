...
class ConferenceConnector {
     ...
     */
    connect() {
		// For handling direct meeting URL.
        const displayName
        = APP.store.getState()['features/base/settings'].displayName;
        console.log('display name', room);
        if(displayName === undefined || displayName === '' || displayName === "me") {
            window.location.href = APP.UI.getURL();
        }
